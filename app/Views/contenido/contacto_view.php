...
<div class="container row mx-auto justify-content-evenly my-4 g-3" data-bs-theme="dark">
    ...
    <div class="col-md-6 border" data-bs-theme="dark" data-aos="zoom-in">
        ...
        <form class="px-5 py-2" action="<?= base_url('mensaje') ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="asunto" type="text" class="form-control" id="exampleInputPassword1">
            </div>
            <div class="mb-3">
                <label for="mensaje" class="form-label">Mensaje</label>
                <textarea name="mensaje" class="form-control bg-dark" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
