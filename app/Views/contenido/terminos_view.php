...
<div class="container mt-3" data-bs-theme="dark" data-aos="zoom-in">
    ...
    <p class="container p-4 bg-secondary-subtle text-secondary-emphasiss" style="text-align: justify;">
        ...
        <br/>
        Edad mínima: Debes tener al menos 18 años o contar con autorización de un tutor legal para comprar. <br/>
        Cuenta de usuario: Es responsable de mantener la confidencialidad de su contraseña y de toda actividad bajo su cuenta. <br/>
        Prohibido: Usar el sitio para fines ilegales, copiar diseños o interferir con su seguridad. <br/>
        <br/>
        ...
        <b>3. Compras y Pagos</b> <br/>
        Métodos de pago: Aceptamos tarjetas (Visa, Mastercard), PayPal, y transferencias bancarias. <br/>
        Seguridad: Usamos encriptación SSL para proteger tus datos. No almacenamos información de tarjetas. <br/>
        Confirmación: Recibirás un email con los detalles de tu pedido una vez procesado el pago. <br/>
        <br/>

        <b>4. Envíos y Entregas</b> <br/>
